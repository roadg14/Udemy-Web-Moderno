...
function transformacaoJS(callback){ // cb
    return gulp.src('src/**/*.js') // Seleciona qualquer arquivo dentro de pastas com extensão .js ou só fazer -> gulp.src('NomeDaPasta/**/*') já seleciona tudo.
