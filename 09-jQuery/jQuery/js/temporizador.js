(function ($) {
    $.fn.temporizador = function (opcoes) {
        const opcoesFinais = $.extend({ // Isso aqui vai sobreEscrever oque esta no Html.
            mensagem: 'Em breve!',
            horario: '23:59:59'
        }, opcoes)

        const horaDezena = $('<span class="digito">').html('0') // Class="digito" tem que estar com o css já configurado.
        ...
        const regex = new RegExp(/(\d\d):(\d\d):(\d\d)/) // Grupo de capitura
